//
//  CustromSwitchHome.swift
//  HandsUp
//
//  Created by 김민경 on 2023/01/26.
//

import UIKit

@IBDesignable
public class CustromSwitchHome: UIControl {
...
extension CustromSwitchHome {
    fileprivate func setupUI() {
        ...
        self.backgroundColor = self.isOn ? self.offTintColor : self.onTintColor
