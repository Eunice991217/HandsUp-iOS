...
class SixthTabViewController: UIViewController, CLLocationManagerDelegate{
    ...
    override func viewDidLoad() {
        ...
        let filteredList = map_list!.filter { $0.tag == "여행" }
        print("filteredList 지도 여행 개수 : \(filteredList.count)")
