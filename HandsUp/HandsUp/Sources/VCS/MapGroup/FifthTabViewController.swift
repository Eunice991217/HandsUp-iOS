...
class FifthTabViewController: UIViewController, CLLocationManagerDelegate{
    ...
    override func viewDidLoad() {
        ...
        let filteredList = map_list!.filter { $0.tag == "취미" }
        print("filteredList 지도 취미 개수 : \(filteredList.count)")
