...
class ThirdTabViewController: UIViewController, CLLocationManagerDelegate{
    ...
    override func viewDidLoad() {
        ...
        let filteredList = map_list!.filter { $0.tag == "밥" }
        print("filteredList 지도 밥 개수 : \(filteredList.count)")
