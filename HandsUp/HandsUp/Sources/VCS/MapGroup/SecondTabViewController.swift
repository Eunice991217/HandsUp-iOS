...
class SecondTabViewController: UIViewController, CLLocationManagerDelegate{
    ...
    override func viewDidLoad() {
        ...
        map_list?.append(ShowMapList_rp_getBoardMap(boardIdx: 42, nickname: "aa", character:  ShowMapList_rp_character(eye: "1", eyeBrow: "1", glasses: "1", nose: "1", mouth: "1", hair: "2", hairColor: "1", skinColor: "1", backGroundColor: "2"), latitude: 37.55062343729491, longitude: 127.07303737298145, createdAt: "aa", tag: "Talk"))
