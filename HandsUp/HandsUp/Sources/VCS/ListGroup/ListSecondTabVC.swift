...
class ListSecondTabVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        self.myTableView.register(SecondListTableViewCell.self,
                              forCellReuseIdentifier: "SecondListTableViewCell")
...
//        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: SecondListTableViewCell.id, for: indexPath) as? SecondListTableViewCell else { return UITableViewCell() }
