...
class ListSixthTabVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        self.myTableView.register(FifthListTableViewCell.self,
                              forCellReuseIdentifier: "FifthListTableViewCell")
...
//        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: FifthListTableViewCell.id, for: indexPath) as? FifthListTableViewCell else { return UITableViewCell() }
        
        cell.name.text = MyHomeList6Data[indexPath.row].name
        ...
        cell.location.text = MyHomeList6Data[indexPath.row].location
...
//        cell.location.font = .systemFont(ofSize: 14)
        ...
        cell.time.text = MyHomeList6Data[indexPath.row].time
...
//        cell.time.font = .systemFont(ofSize: 14)
        ...
        cell.content.text = MyHomeList6Data[indexPath.row].content
...
//        cell.content.font = .systemFont(ofSize: 14)
        ...
        cell.img.image = MyHomeList6Data[indexPath.row].profileImage
...
let MyHomeList6Data: [MyHomeList6DataModel] = [
    MyHomeList6DataModel(
